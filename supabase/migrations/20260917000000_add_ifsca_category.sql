-- ============================================================
-- ADD IFSCA (GIFT CITY / IFSC) REGULATOR CATEGORY MIGRATION
-- ============================================================
...
ALTER TABLE updates ADD CONSTRAINT updates_category_check 
  CHECK (category IN ('MCA', 'SEBI', 'RBI', 'NCLT', 'IBC', 'FEMA', 'CCI', 'LABOUR', 'IFSCA'));
...
ALTER TABLE compliance_entries ADD CONSTRAINT compliance_entries_regulator_check 
  CHECK (regulator IN ('mca', 'sebi', 'rbi', 'income_tax', 'fema', 'nclt', 'ibc', 'gst', 'labor_law', 'labour', 'cci', 'other', 'ifsca'));