...
export default function NewArticle() {
    ...
    return (
        <div className="pb-24 content-fade-in">
            ...
            <div className="flex flex-col lg:flex-row gap-8">
                ...
                <div className={`w-full lg:w-[60%] space-y-6 ${activeTab === 'preview' ? 'hidden lg:block' : 'block'}`}>
                    ...
                    <div className="border border-slate-200/80 dark:border-slate-800 rounded-xl p-5 bg-white dark:bg-slate-900 shadow-card ring-1 ring-slate-900/[0.02] space-y-4">
                        <div>
                            ...
                            <div className="flex gap-2 items-start">
                                <input
                                    ...
                                    className="flex-1 border border-slate-300 dark:border-slate-800 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-gold focus:outline-none font-mono bg-white dark:bg-slate-950 text-slate-800 dark:text-slate-100"
                                />
                                {slugEdited && (
                                    <button
                                        type="button"
                                        ...
                                        className="text-xs font-medium text-slate-500 dark:text-slate-400 hover:text-navy dark:hover:text-slate-200 px-3 py-2 bg-slate-100 dark:bg-slate-800 rounded-lg"
                                    >
                                        Reset
                                    </button>
                                )}
                        ...
                        <div>
                            ...
                            <select
                                ...
                                className="w-full border border-slate-300 dark:border-slate-800 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-gold focus:outline-none bg-white dark:bg-slate-950 text-slate-800 dark:text-slate-100"
                            >
                    ...
                    <div className="border border-slate-200/80 dark:border-slate-800 rounded-xl p-5 bg-white dark:bg-slate-900 shadow-card ring-1 ring-slate-900/[0.02]">
                        ...
                        <textarea
                            ...
                            className="w-full border border-slate-300 dark:border-slate-800 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-gold focus:outline-none resize-none bg-white dark:bg-slate-950 text-slate-800 dark:text-slate-100"
                        />
                    ...
                    <div className="border border-slate-200/80 dark:border-slate-800 rounded-xl p-5 bg-white dark:bg-slate-900 shadow-card ring-1 ring-slate-900/[0.02] space-y-5">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full border border-slate-300 dark:border-slate-800 rounded-lg px-4 py-3 text-navy dark:text-slate-200 focus:outline-none focus:ring-2 focus:ring-amber-400 focus:border-transparent bg-white dark:bg-slate-950"
                                maxLength={200}
                            />
                        </div>
                        ...
                        <div>
                            ...
                            {showBulkTldr ? (
                                <div className="space-y-2 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-850 p-3 rounded-lg mb-3">
                                    ...
                                    <textarea 
                                        ...
                                        rows={4}
                                        className="w-full px-3 py-2 border border-slate-300 dark:border-slate-800 rounded-lg text-xs focus:ring-2 focus:ring-amber-400 focus:outline-none bg-white dark:bg-slate-950 text-slate-800 dark:text-slate-100"
                                    />
                                    <button 
                                        type="button" 
                                    ...
                                    {keyChanges.map((kc, idx) => (
                                        <div key={idx} className="flex gap-2">
                                            <input
                                                ...
                                                className="flex-1 border border-slate-300 dark:border-slate-800 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-amber-400 focus:border-transparent bg-white dark:bg-slate-950 text-slate-800 dark:text-slate-100"
                                            />
                            ...
                            <details className="mt-3 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-850 rounded-xl overflow-hidden transition-all duration-200">
                                <summary className="cursor-pointer text-xs font-semibold text-slate-700 dark:text-slate-300 hover:text-navy dark:hover:text-slate-100 px-4 py-3 bg-slate-100/50 dark:bg-slate-900/50 flex justify-between items-center select-none">
                                    <span>💡 Google & Bing AI SEO Guidelines & Templates</span>
                                    <span className="text-slate-400 text-[10px]">Click to expand</span>
                                </summary>
                                <div className="p-4 space-y-4 text-xs text-slate-600 dark:text-slate-400 leading-relaxed border-t border-slate-200 dark:border-slate-850">
                                    {/* 1. Bullet Takeaways */}
                                    <div>
                                        ...
                                        <ul className="list-disc list-inside mt-1 ml-1 space-y-1 text-slate-500 dark:text-slate-450">
                                    ...
                                    <div className="border-t border-slate-200/80 dark:border-slate-800 pt-3">
                                        ...
                                        <ul className="list-disc list-inside space-y-1.5 text-slate-500 dark:text-slate-450">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="border border-slate-300 dark:border-slate-800 rounded-lg px-4 py-3 text-navy dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-amber-400 focus:border-transparent w-full bg-white dark:bg-slate-950"
                            />
                        ...
                        <div>
                            ...
                            <select
                                ...
                                className="w-full border border-slate-300 dark:border-slate-800 rounded-lg px-4 py-3 text-navy dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-amber-400 focus:border-transparent bg-white dark:bg-slate-950"
                            >
                    ...
                    <div className="border border-slate-200/80 dark:border-slate-800 rounded-xl p-5 bg-white dark:bg-slate-900 shadow-card ring-1 ring-slate-900/[0.02] space-y-4">
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                className="w-full border border-slate-300 dark:border-slate-800 rounded-lg px-3 py-2 text-sm text-navy dark:text-slate-100 bg-white dark:bg-slate-950 focus:ring-2 focus:ring-gold focus:outline-none resize-none"
                                rows={3}
                                maxLength={250}
                            />
                    ...
                    <div className="border border-slate-200/80 dark:border-slate-800 rounded-xl p-5 bg-white dark:bg-slate-900 shadow-card ring-1 ring-slate-900/[0.02] grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div className="md:col-span-2">
                            <h3 className="font-bold text-navy dark:text-slate-200 text-sm border-b border-slate-100 dark:border-slate-850 pb-2 mb-4">Sources & Publishing</h3>
                        </div>
                        ...
                        <div className="md:col-span-2 bg-slate-50 dark:bg-slate-950 p-4 rounded-lg border border-slate-100 dark:border-slate-850">
                ...
                <div className={`w-full lg:w-[40%] ${activeTab === 'write' ? 'hidden lg:block' : 'block'}`}>
                    <div className="sticky top-24 space-y-6">
                        ...
                        <h3 className="text-xs font-bold text-slate-400 dark:text-slate-500 uppercase tracking-wider mb-6 pb-4 border-b border-slate-100 dark:border-slate-850">Live Preview</h3>
            ...
            <div className="fixed bottom-0 left-0 lg:left-[240px] right-0 bg-white dark:bg-slate-950 border-t border-slate-200 dark:border-slate-850 px-6 py-4 flex justify-between items-center z-40 shadow-lg">
                ...
                <div className="flex gap-3">
                    ...
                    <button
                        ...
                        disabled={loading || success}
                        className="px-5 py-2 border border-gold text-gold font-semibold rounded-lg hover:bg-gold/10 transition-colors disabled:opacity-50 text-sm hidden sm:block bg-transparent dark:bg-slate-900"
                    >
                        Schedule
                    </button>
                    <button
