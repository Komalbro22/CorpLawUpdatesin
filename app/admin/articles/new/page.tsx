...
const CATEGORIES: Category[] = ['MCA', 'SEBI', 'RBI', 'NCLT', 'IBC', 'FEMA', 'CCI']
...
export default function NewArticle() {
    ...
    return (
        <div className="pb-24 content-fade-in">
                            ...
                            <div className="flex gap-2 items-start">
                                ...
                                {slugEdited && (
                                    <button
                                        ...
                                        className="text-xs font-medium text-slate-500  hover:text-slate-900 dark:hover:text-slate-800 px-3 py-2 bg-slate-100  rounded-lg"
                                    >
                                        Reset
                                    </button>
                                )}
                    ...
                    <div className="border border-slate-200/80  rounded-xl p-5 bg-white bg-white shadow-card ring-1 ring-slate-900/[0.02] space-y-5">
                        ...
                        <div>
                            ...
                            <details className="mt-3 bg-slate-50 bg-slate-50 border border-slate-200  rounded-xl overflow-hidden transition-all duration-200">
                                <summary className="cursor-pointer text-xs font-semibold text-slate-700  hover:text-slate-900 dark:hover:text-slate-900 px-4 py-3 bg-slate-100/50 bg-white/50 flex justify-between items-center select-none">
            ...
            <div className="fixed bottom-0 left-0 lg:left-[240px] right-0 bg-white bg-slate-50 border-t border-slate-200  px-6 py-4 flex justify-between items-center z-40 shadow-lg">
                ...
                <div className="flex gap-3 items-center">
                    ...
                    <button
                        ...
                        disabled={loading || success}
                        className="px-5 py-2 border border-gold text-gold font-semibold rounded-lg hover:bg-gold/10 transition-colors disabled:opacity-50 text-sm hidden sm:block bg-transparent bg-white"
                    >
                        Schedule
                    </button>
                    <button
