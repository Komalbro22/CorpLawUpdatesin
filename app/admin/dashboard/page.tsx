            ...
            <div className="bg-white/90 backdrop-blur-xl border border-slate-200/90 rounded-2xl p-5 sm:p-7 shadow-sm transition-all duration-300">
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5">
                    <div className="space-y-1.5">
                        ...
                        <h2 className="text-xl sm:text-2xl lg:text-3xl font-heading font-extrabold text-slate-900 tracking-tight">
                    ...
                    <div className="flex items-center gap-2 sm:gap-3 flex-wrap">
                        ...
                        <div className="flex-1 sm:flex-none bg-slate-50 border border-slate-200/80 rounded-xl px-3.5 py-2 text-center min-w-[90px]">
                            ...
                            <p className="text-xs text-slate-500 font-medium">New Subs</p>
                        </div>
                        <div className="flex-1 sm:flex-none bg-slate-50 border border-slate-200/80 rounded-xl px-3.5 py-2 text-center min-w-[90px]">
                            ...
                            <p className="text-xs text-slate-500 font-medium">Calculations</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="mt-5 pt-5 border-t border-slate-100 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-2 sm:gap-2.5">
                    ...
                    <Link
                        ...
                        className="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-amber-500 to-amber-400 hover:from-amber-400 hover:to-amber-300 text-slate-950 font-bold px-3 py-2.5 rounded-xl text-xs shadow-sm shadow-amber-500/15 transition-all duration-150 active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-500"
                    >
                        <PenSquare className="w-3.5 h-3.5 text-slate-950 shrink-0" />
                    ...
                    <Link
                        href="/admin/radar"
                        className="inline-flex items-center justify-center gap-2 bg-slate-50/90 hover:bg-slate-100 text-slate-700 hover:text-slate-900 font-medium px-3 py-2.5 rounded-xl text-xs border border-slate-200/80 hover:border-slate-300 transition-all duration-150 active:scale-95 shadow-sm group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-500"
                    >
                        <Radio className="w-3.5 h-3.5 text-amber-500 group-hover:animate-pulse shrink-0" />
                        <span>Radar Scanner</span>
                    </Link>

                    <Link
                        href="/admin/notifications"
                        className="inline-flex items-center justify-center gap-2 bg-slate-50/90 hover:bg-slate-100 text-slate-700 hover:text-slate-900 font-medium px-3 py-2.5 rounded-xl text-xs border border-slate-200/80 hover:border-slate-300 transition-all duration-150 active:scale-95 shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-500"
                    >
                    ...
                    <a
                        ...
                        className="inline-flex items-center justify-center gap-1.5 bg-slate-50/90 hover:bg-slate-100 text-slate-700 hover:text-slate-900 font-medium px-3 py-2.5 rounded-xl text-xs border border-slate-200/80 hover:border-slate-300 transition-all duration-150 active:scale-95 shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-500"
                    >
                ...
                <div className="bg-white/80 backdrop-blur-xl border border-slate-200/90 rounded-2xl p-5 shadow-sm hover:shadow-md transition-all duration-200 group">
                    ...
                    <div className="mt-3">
                        ...
                        <div className="flex justify-between text-xs text-slate-500 mt-1.5">
                            ...
                            <span className="font-semibold text-slate-700">{pct(publishedCount, TARGETS.published)}%</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white/80 backdrop-blur-xl border border-slate-200/90 rounded-2xl p-5 shadow-sm hover:shadow-md transition-all duration-200 group">
                    ...
                    <div className="mt-3">
                        ...
                        <div className="flex justify-between text-xs text-slate-500 mt-1.5">
                            ...
                            <span className="font-semibold text-slate-700">{pct(activeSubscribers, TARGETS.subscribers)}%</span>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="bg-white/90 backdrop-blur-xl border border-slate-200/90 rounded-2xl p-5 sm:p-6 shadow-sm">
                        ...
                        <div className="hidden sm:block overflow-hidden border border-slate-200/70 rounded-xl">
                            <table className="w-full text-left text-sm border-collapse">
                                <thead>
                                    <tr className="bg-slate-50/80 border-b border-slate-200/70 text-slate-500 text-xs uppercase tracking-wider font-semibold">
                                        ...
                                        return (
                                            <tr key={article.id} className="hover:bg-slate-50/60 transition-colors group">
                                                ...
                                                <td className="px-3 py-3">
                                                    <span className={`inline-block px-2.5 py-0.5 rounded-full text-xs font-semibold border ${catStyle.bg} ${catStyle.text} ${catStyle.border}`}>
                                                        {article.category}
                                                    </span>
                                                </td>
                                                <td className="px-3 py-3">
                    ...
                    <div className="bg-gradient-to-br from-amber-50/40 via-white to-orange-50/20 border border-amber-200/80 rounded-2xl p-5 sm:p-6 shadow-sm">
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 pt-2">
                            <div className="bg-white/80 border border-slate-200/80 rounded-xl p-3 text-center">
                                ...
                                <p className="text-xs text-slate-500 mt-0.5">Circulars & Rules</p>
                            </div>
                            <div className="bg-white/80 border border-slate-200/80 rounded-xl p-3 text-center">
                                <p className="text-xs font-bold text-emerald-700">SEBI</p>
                                <p className="text-xs text-slate-500 mt-0.5">LODR & Circulars</p>
                            </div>
                            <div className="bg-white/80 border border-slate-200/80 rounded-xl p-3 text-center">
                                <p className="text-xs font-bold text-indigo-700">RBI</p>
                                <p className="text-xs text-slate-500 mt-0.5">Banking & FEMA</p>
                            </div>
                            <div className="bg-white/80 border border-slate-200/80 rounded-xl p-3 text-center">
                                <p className="text-xs font-bold text-amber-700">IBBI</p>
                                <p className="text-xs text-slate-500 mt-0.5">IBC Regulations</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="space-y-3.5">
                            ...
                            <div className="grid grid-cols-2 gap-2.5">
                                <div className="bg-slate-50 border border-slate-200/80 rounded-xl p-3">
                                    <p className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Runs Logged</p>
                                    <p className="text-lg font-heading font-bold text-slate-900 mt-0.5 tabular-nums">
                                        {calcStats.length}
                                    </p>
                                </div>
                                <div className="bg-slate-50 border border-slate-200/80 rounded-xl p-3">
                                    <p className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Projected Fees</p>
                                    ...
                                    return (
                                        <div key={type} className="space-y-1">
                                            <div className="flex justify-between items-center text-xs">
                                                ...
                                                <span className="bg-slate-100 text-slate-700 font-bold px-2 py-0.5 rounded text-xs shrink-0">
                                                    {count}
                                                </span>
                                            </div>
                                            <div className="h-1.5 w-full bg-slate-100 rounded-full overflow-hidden">
