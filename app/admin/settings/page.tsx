    ...
    <div className="space-y-8 max-w-3xl">
      <div>
        ...
        <p className="text-slate-500 text-sm mt-1">
          Update social links, WhatsApp channel, 
          SEO settings and more. Changes apply instantly.
        </p>
      </div>
        ...
        <div key={group.title}
          ...
          <div className="divide-y divide-slate-100">
            {group.keys.map((key) => {
              ...
              const isLong = key === 'announcement_bar' || 
      ...
      <div className="bg-white rounded-xl border 
                      border-red-200 overflow-hidden">
