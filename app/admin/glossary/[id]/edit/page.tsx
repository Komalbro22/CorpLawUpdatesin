...
export default function EditGlossaryTermPage({ params }: Props) {
  ...
  if (isLoading) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[calc(100vh-200px)] text-slate-400">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-slate-400 mt-0.5">Revise details and fine-tune your legal terminology.</p>
          </div>
        </div>
            ...
            <div className="flex justify-between items-center pb-2 border-b border-slate-800 mb-4">
              ...
              <div className="flex gap-2">
                <button 
                  ...
                  className="inline-flex items-center gap-1.5 text-xs font-bold text-slate-300 hover:text-white bg-slate-955 hover:bg-slate-900 px-3 py-2 rounded-lg transition-colors border border-slate-805"
                >
        ...
        <div className="space-y-6">
          ...
          <div className="admin-card p-6">
            ...
            {isSubstantial ? (
              ...
              <div className="p-4 bg-slate-950/45 border border-slate-855 rounded-xl mb-6">
                <div className="flex gap-2">
          ...
          <div className="admin-card p-6">
            ...
            <input 
              ...
              className="w-full px-4 py-2 bg-slate-955 border border-slate-800 rounded-xl focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500 text-sm font-medium text-white"
            ...
            {keywords.length > 0 && (
              <div className="flex flex-wrap gap-2 mt-3 p-3 bg-slate-950/40 border border-slate-855 rounded-xl">
                {keywords.map((kw, index) => (
                  <span 
                    key={index} 
                    className="inline-flex items-center gap-1.5 bg-slate-900 border border-slate-800 text-slate-205 text-xs font-semibold px-2.5 py-1.5 rounded-lg shadow-sm"
                  >
                    {kw}
                    <button 
                      type="button" 
          ...
          <div className="admin-card p-6">
            ...
            <input 
              ...
              className="w-full px-4 py-2 bg-slate-955 border border-slate-805 rounded-xl focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500 text-sm font-medium text-white"
          ...
          <div className="admin-card p-6 space-y-5">
            ...
            <div className="space-y-1.5">
              ...
              <input 
                ...
                className="w-full px-4 py-2 bg-slate-955 border border-slate-805 rounded-xl focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500 text-sm text-white"
              />
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <textarea 
                ...
                rows={3}
                className="w-full px-4 py-2 bg-slate-955 border border-slate-805 rounded-xl focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500 text-sm resize-none text-white animate-none"
              />
            </div>
      ...
      {isPreviewOpen && (
        <div className="fixed inset-0 z-50 overflow-y-auto bg-slate-955/80 backdrop-blur-sm flex justify-center p-4 sm:p-6 md:p-10">
          <div className="relative w-full max-w-4xl bg-slate-950 rounded-3xl shadow-2xl border border-slate-800 overflow-hidden flex flex-col my-auto max-h-[90vh]">
            ...
            {/* Modal Header */}
            <div className="flex justify-between items-center px-8 py-5 bg-slate-900 border-b border-slate-855 shrink-0">
              <div>
                  ...
                  <div className="space-y-4">
                    {(faqs.length > 0 ? faqs.map(f => ({ q: f.q, a: f.a })) : [
                      ...
                      <div key={i} className="border border-slate-850 rounded-xl p-4 bg-slate-900/40">
                        ...
                        <p className="mt-3 text-slate-300 text-sm leading-relaxed border-t border-slate-855/50 pt-3">
