...
const nextConfig = {
  ...
  async headers() {
    ...
    const cspHeader = `default-src 'self'; script-src 'self' 'unsafe-inline'${scriptSrcEval} https://static.cloudflareinsights.com https://www.googletagmanager.com https://va.vercel-scripts.com https://*.clarity.ms https://pagead2.googlesyndication.com https://*.googlesyndication.com https://googleads.g.doubleclick.net https://news.google.com; style-src 'self' 'unsafe-inline'; img-src 'self' blob: data: https: http: https://i.ibb.co https://images.unsplash.com https://*.clarity.ms https://pagead2.googlesyndication.com https://googleads.g.doubleclick.net; font-src 'self' data:; connect-src 'self' blob: data: https: http: https://i.ibb.co https://images.unsplash.com https://analytics.google.com https://stats.g.doubleclick.net https://www.googletagmanager.com https://static.cloudflareinsights.com https://*.supabase.co wss://*.supabase.co https://vitals.vercel-insights.com https://*.clarity.ms https://pagead2.googlesyndication.com https://*.googlesyndication.com https://googleads.g.doubleclick.net; frame-src 'self' https://googleads.g.doubleclick.net https://pagead2.googlesyndication.com https://tpc.googlesyndication.com https://news.google.com; frame-ancestors 'self'; object-src 'none'; base-uri 'self';`
