export default function LoadingSkeleton() {
    return (
        <div className="flex h-full flex-col overflow-hidden rounded-xl border border-slate-200/80 dark:border-slate-800 border-t-[3px] border-t-slate-200 dark:border-t-slate-700 bg-white dark:bg-slate-900 shadow-card animate-pulse">
            {/* Image aspect-ratio video placeholder */}
            <div className="relative w-full aspect-video bg-slate-200 dark:bg-slate-800 flex-shrink-0" />
            ...
            <div className="p-5 flex flex-col flex-1 space-y-4">
                ...
                {/* Footer metadata */}
                <div className="mt-auto flex items-end justify-between gap-4 border-t border-slate-100/80 dark:border-slate-800 pt-3">
                    ...
                    <div className="flex shrink-0 items-center gap-2">
                        ...
                        <div className="h-7 w-7 bg-slate-200 dark:bg-slate-800 rounded-md" />
                    </div>
                </div>
            </div>
        </div>
