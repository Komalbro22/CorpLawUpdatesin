      ...
      {guidanceModalOpen && (
        ...
        >
          <div
            ...
            className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl shadow-2xl max-w-md w-full p-6 animate-fade-in"
          ...
          >
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 id="guidance-modal-title" className="font-heading font-bold text-base text-navy dark:text-white">
              ...
              <button
                onClick={() => setGuidanceModalOpen(false)}
                aria-label="Close guidance dialog"
