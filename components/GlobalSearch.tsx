                ...
                <div className="px-4 py-8 text-center text-slate-400 text-sm">
                  ...
                  {recentSearches.length > 0 && (
                    <div className="mt-6 text-left">
                      <p className="text-xs font-semibold text-slate-500 uppercase tracking-wide mb-2">Recent searches</p>
                      <div className="flex flex-wrap gap-2 justify-center">
                        {recentSearches.map(term => (
                          <button
                            ...
                            className="text-xs bg-slate-100 hover:bg-amber-50 text-slate-600 hover:text-amber-800 px-3 py-1.5 rounded-full border border-slate-200 transition-colors"
                          >
                            {term}
                          </button>
                        ))}
