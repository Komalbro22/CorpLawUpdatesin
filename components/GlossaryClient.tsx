...
export default function GlossaryClient({ terms }: { terms: GlossaryTerm[] }) {
  ...
  const categories = ['ALL', 'MCA', 'SEBI', 'IBC', 'RBI', 'FEMA', 'NCLT', 'CCI', 'LABOUR', 'IFSCA']
      ...
      <div className="flex-1 w-full max-w-4xl mx-auto">
        ...
        >
          ...
          <input
            ...
            toolparamdescription="Search keyword to find legal terms and definitions."
          />
        </form>
        ...
        {/* Mobile A-Z Navigation (only show on small screens) */}
        {!search && (
          <div className="flex lg:hidden flex-wrap gap-2 justify-center mb-12">
            {alphabet.map((letter) => {
