...
export const mcaForms: MCAForm[] = [
  {
    ...
    aliases: [
      ...
      'mgt-7 late fee calculator',
      'mgt 7 fees calculator',
      'mgt-7 fees calculator',
      'mgt 7 penalty calculator',
      'mgt 7 additional fee calculator',
      'form mgt 7 fee calculator',
      'form mgt 7 late fee calculator',
      'mgt 7 late filing fee calculator',
      'mgt 7 mca fee calculator',
      'mgt 7 annual return fee calculator',
      'mgt 7 calculator',
      'mgt 7 late fee per day',
      'mgt 7 delay fees calculator',
      'mgt 7 section 92 penalty',
      'mgt 7 late filing penalty',
    ...
    faqItems: [
      ...
      { question: 'What is the normal base filing fee for Form MGT-7?', answer: 'Under Table A (Item 5), normal filing fee for Form MGT-7 is graded by nominal (authorized) share capital: Less than ₹1 Lakh: ₹200; ₹1L to ₹4.99L: ₹300; ₹5L to ₹24.99L: ₹400; ₹25L to ₹99.99L: ₹500; ₹1 Crore or more: ₹600. For companies without share capital, the normal fee is ₹200 (Item 6).' },
      { question: 'What is the statutory adjudication penalty under Section 92(5)?', answer: 'Under Section 92(5) of the Companies Act 2013 (as decriminalized), default in filing annual returns attracts an adjudication penalty of ₹10,000 plus ₹100 per day after the first day of continuing default, subject to a maximum cap of ₹2,00,000 for the company and ₹50,000 per officer in default. This civil penalty is separate from the MCA portal filing fee and is adjudicated by the ROC.' },
      { question: 'What is the statutory due date for filing Form MGT-7 in FY 2026-27?', answer: 'Form MGT-7 must be filed within 60 calendar days from the date of the Annual General Meeting (AGM) pursuant to Section 92(4). For companies following the standard April–March financial year holding their AGM on the last permitted statutory date of 30 September, the standard filing deadline is 29 November.' },
      { question: 'Who is required to file Form MGT-7 vs Form MGT-7A?', answer: 'All companies registered under the Companies Act 2013—including non-small Private Limited Companies, Public Limited Companies (listed and unlisted), and Producer Companies—must file full Form MGT-7. One Person Companies (OPCs) and Small Companies (paid-up capital ≤ ₹10 Cr and turnover ≤ ₹100 Cr) are exempt from MGT-7 and file Form MGT-7A (Abridged Annual Return).' },
      { question: 'When is Form MGT-8 certification by a Practicing CS mandatory?', answer: 'Under Section 92(2) read with Rule 11(2), Form MGT-8 (Certificate by a Company Secretary in Practice) must be attached to Form MGT-7 for: (1) Every listed company, and (2) Every company having paid-up share capital of ₹10 Crore or more, OR turnover of ₹50 Crore or more.' },
      { question: 'Does Section 446B lesser penalty relief apply to MGT-7 filings?', answer: 'Yes. If the company filing Form MGT-7 qualifies as a DPIIT-recognized Start-up Company or a Producer Company, Section 446B applies to cap the Section 92(5) adjudication penalties to 50% of the statutory exposure (maximum ₹1,00,000 for the company and ₹25,000 per officer in default).' }
    ],
  ...
  },
  {
    ...
    aliases: [
      'mgt 7a fee calculator',
      'mgt-7a fee calculator',
      'mgt 7a late fee calculator',
      'mgt-7a late fee calculator',
      'mgt 7a fees calculator',
      'mgt-7a fees calculator',
      'mgt 7a penalty calculator',
      'form mgt 7a fee calculator',
      'small company annual return fee calculator',
      'opc annual return fee calculator',
      'mgt 7a late filing fee calculator',
      'mgt 7a calculator',
      'mgt 7a',
      'mgt7a',
      'small company annual return',
      'opc annual return',
    ...
    metaTitle: 'MGT 7A Fee Calculator — Small Co & OPC Annual Return (FY 2026-27)',
    metaDescription: 'Calculate Form MGT-7A filing fees on MCA V3: Table A base fees, ₹100/day late fees, new Small Company thresholds (₹10 Cr/₹100 Cr), and Section 446B 50% penalty relief.',
  ...
  },
  {
    ...
    aliases: [
      ...
      'aoc-4 fee calculator',
      'aoc 4 late fee calculator',
      'aoc-4 late fee calculator',
      'aoc 4 penalty calculator',
      'aoc-4 penalty calculator',
      'aoc 4 fees calculator',
      'aoc-4 fees calculator',
      'form aoc 4 fee calculator',
      'form aoc 4 late fee calculator',
      'aoc form fees',
      'aoc fees',
      'aoc form fee',
      'aoc fee',
    ...
    metaTitle: 'AOC 4 Fee Calculator — Form AOC-4 Late Filing Fees & Penalty (FY 2026-27)',
  ...
  },
  {
    ...
    aliases: [
      ...
      'spice+ fee calculator',
      'company incorporation fee calculator',
      'inc 32 fee calculator',
      'company registration fee calculator',
    ...
    baseFeeSlab: 'nil',
    concessionApplies: true,
    metaTitle: 'SPICe+ Fee Calculator — MCA Company Incorporation & Stamp Duty (2026)',
  ...
  },
  {
    ...
    aliases: [
      ...
      'dir-3 kyc fee calculator',
      'dir 3 kyc late fee calculator',
      'dir 3 kyc penalty calculator',
      'din kyc fee calculator',
      'dir 3 kyc calculator',
      'dir3 kyc',
      'director kyc',
      'din kyc',
      'dir 3 kyc',
    ...
    baseFeeSlab: 'nil',
    concessionApplies: false,
    metaTitle: 'DIR 3 KYC Fee Calculator — Due Date, Penalty & Deactivation Rules (FY 2026-27)',
  ...
  },
  {
    ...
    aliases: [
      ...
      'adt-1 fee calculator',
      'adt 1 late fee calculator',
      'adt-1 late fee calculator',
      'adt 1 penalty calculator',
      'form adt 1 fee calculator',
      'adt 1 late fees',
    ...
    baseFeeSlab: 'standard_company_slab',
    concessionApplies: false,
    metaTitle: 'ADT 1 Fee Calculator — Form ADT-1 Late Filing Fees & Multipliers (FY 2026-27)',
  ...
  },
  {
    ...
    aliases: [
      ...
      'dir-12 fee calculator',
      'dir 12 late fee calculator',
      'dir-12 late fee calculator',
      'dir 12 penalty calculator',
      'form dir 12 fee calculator',
      'dir12',
      'dir 12',
    ...
    baseFeeSlab: 'standard_company_slab',
    concessionApplies: false,
    metaTitle: 'DIR 12 Fee Calculator — Form DIR-12 Late Filing Fees & Penalty (FY 2026-27)',
  ...
  },
  {
    ...
    aliases: [
      ...
      'pas-3 fee calculator',
      'pas 3 late fee calculator',
      'pas-3 late fee calculator',
      'pas 3 penalty calculator',
      'form pas 3 fee calculator',
      'return of allotment fee calculator',
      'pas 3 calculator',
      'pas 3 delay fee calculator',
      'pas3',
      'pas 3',
      'return of allotment',
      'share allotment',
    ...
    baseFeeSlab: 'standard_company_slab',
    concessionApplies: true,
    metaTitle: 'PAS 3 Fee Calculator — Form PAS-3 Late Filing Fees & Penalty (FY 2026-27)',
  ...
  },
  {
    ...
    aliases: [
      ...
      'pas-6 fee calculator',
      'pas 6 late fee calculator',
      'pas-6 late fee calculator',
      'pas 6 penalty calculator',
      'form pas 6 fee calculator',
      'pas 6 fees calculator',
      'pas 6 calculator',
      'reconciliation of share capital audit fee calculator',
      'rule 9a fee calculator',
      'rule 9b fee calculator',
      'pas 6',
      'pas-6',
      'pas6',
      'form pas-6',
    ...
    metaTitle: 'PAS 6 Fee Calculator — Form PAS-6 Demat Audit & Late Fees (FY 2026-27)',
  ...
  },
  {
    ...
    aliases: [
      ...
      'chg-1 fee calculator',
      'chg 1 late fee calculator',
      'chg-1 late fee calculator',
      'chg 1 penalty calculator',
      'form chg 1 fee calculator',
      'charge creation fee calculator',
      'chg 1 fees calculator',
      'chg 1 calculator',
      'chg 1 ad valorem fee calculator',
      'chg 1',
      'chg-1',
      'chg1',
      'form chg 1',
  ...
  },
  {
    ...
    aliases: [
      ...
      'msme-1 fee calculator',
      'msme 1 penalty calculator',
      'msme-1 penalty calculator',
      'msme form 1 fee calculator',
      'form msme 1 fee calculator',
      'msme 1 late fee calculator',
      'msme 1 calculator',
      'msme form 1 calculator',
      'msme 1',
      'msme form 1',
      'msme-1 due date',
      'msme-1 penalty',
      'section 405 companies act',
      'msme half yearly return',
      'msme form 1 mca v3',
      'msme delayed payment return'
    ],
    category: 'event',
    ...
    metaTitle: 'MSME 1 Fee Calculator — Form MSME-1 Penalty & Due Date (FY 2026-27)',
  ...
  },
  {
    ...
    aliases: [
      ...
      'dpt-3 late fee calculator',
      'dpt 3 penalty calculator',
      'form dpt 3 fee calculator',
      'dpt 3 fees calculator',
      'dpt 3 calculator',
      'return of deposits fee calculator',
      'dpt-3',
      'dpt3',
      'DPT 3',
      'return of deposits',
      'exempted deposits return',
      'deposit return MCA',
      'rule 16 return'
    ],
    category: 'annual',
    ...
    baseFeeSlab: 'standard_company_slab',
    concessionApplies: false,
    metaTitle: 'DPT 3 Fee Calculator — Form DPT-3 Late Filing Fees & Multipliers (FY 2026-27)',
  ...
  },
  {
    ...
    aliases: [
      ...
      'inc-20a fee calculator',
      'inc 20a late fee calculator',
      'inc-20a late fee calculator',
      'inc 20a penalty calculator',
      'form inc 20a fee calculator',
      'commencement of business fee calculator',
      'inc 20a fees calculator',
      'inc 20a calculator',
      'inc 20a',
      'inc-20a',
    ...
    baseFeeSlab: 'standard_company_slab',
    concessionApplies: true,
    metaTitle: 'INC 20A Fee Calculator — Form INC-20A Late Filing Fees & Penalty (FY 2026-27)',
